...
"[project]/src/app/components/data-grid.tsx [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
function ColumnForm() {
    ...
    const handleSubmit = async (event)=>{
        ...
        setError(null);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].addColumn(name) // Updated to pass name directly
            ;
            setName('');
        } catch (err) {
...
//# sourceMappingURL=src_5fcb0a._.js.map